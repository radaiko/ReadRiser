...
public class FileEntity {
    ...
    public List<SharingHistoryEntry> SharingHistory { get; set; } = new();
...
/// <summary>
/// Sharing history entry for audit trail
/// </summary>
public class SharingHistoryEntry {
    public string Id { get; set; } = string.Empty;
